...
namespace WebRaoTin.Areas.Admin.Controllers
{
    public class DichVusController : Controller
    {
        ...
        {
            ViewBag.LoaiDichVuId = new SelectList(db.LoaiDichVus, "Id", "Name");
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Price,Image,Description,Location,TinTucId,LoaiDichVuId")] DichVu dichVu)
        {
            ...
            ViewBag.LoaiDichVuId = new SelectList(db.LoaiDichVus, "Id", "Name", dichVu.LoaiDichVuId);
            ViewBag.TinTucId = new SelectList(db.TinTucs, "Id", "Title", dichVu.TinTucId);
            return View(dichVu);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Price,Image,Description,Location,TinTucId,LoaiDichVuId")] DichVu dichVu)
        {
            if (ModelState.IsValid)
            {
