...
namespace WebRaoTin.Areas.Admin.Controllers
{
    public class SanPhamsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Price,Image,Description,Location,TinTucId,LoaiSanPhamId")] SanPham sanPham)
        {
            ...
            ViewBag.TinTucId = new SelectList(db.TinTucs, "Id", "Title", sanPham.TinTucId);
            return View(sanPham);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Price,Image,Description,Location,TinTucId,LoaiSanPhamId")] SanPham sanPham)
        {
            if (ModelState.IsValid)
            {
